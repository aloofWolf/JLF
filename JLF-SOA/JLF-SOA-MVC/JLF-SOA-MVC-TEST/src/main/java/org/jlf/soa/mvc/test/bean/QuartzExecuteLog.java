...
import org.jlf.soa.mvc.test.enums.QuartzExecuteResult;
...
public class QuartzExecuteLog extends JLFMVCEntity {
	...
	private Long jobId;
	@JLFMVCBeanFieldMapped(desc = "单据id",isNotNull = true)
	private Long billId;
	@JLFMVCBeanFieldMapped(desc = "执行参数",isNotNull = true)
