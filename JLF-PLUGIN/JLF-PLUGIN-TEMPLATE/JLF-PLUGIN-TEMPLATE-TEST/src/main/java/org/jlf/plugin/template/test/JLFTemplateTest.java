...
import org.jlf.plugin.client.template.JLFTemplateClient;
 ...
 * @date 2019年7月5日
 */
public class JLFTemplateTest{

	public static void main(String[] args) throws Exception {
		JLFCore.starts();
	    getStringFromClassPathMapTest();
		getStringFromClassPathObjTest();
	}
	 ...
	 */
	public static void getStringFromClassPathMapTest() {
	 ...
	 */
	public static void getStringFromClassPathObjTest() {
