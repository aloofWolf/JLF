package org.jlf.plugin.server.core.check.custom.detail.fac;
...
import org.jlf.plugin.server.core.check.custom.detail.CustomerCheck;
import org.jlf.plugin.server.core.check.custom.detail.DateCheck;
import org.jlf.plugin.server.core.check.custom.detail.EnumCheck;
import org.jlf.plugin.server.core.check.custom.detail.ICheck;
import org.jlf.plugin.server.core.check.custom.detail.StringCheck;
import org.jlf.plugin.server.core.check.custom.detail.number.BigDecimalCheck;
import org.jlf.plugin.server.core.check.custom.detail.number.ByteCheck;
import org.jlf.plugin.server.core.check.custom.detail.number.DoubleCheck;
import org.jlf.plugin.server.core.check.custom.detail.number.FloatCheck;
import org.jlf.plugin.server.core.check.custom.detail.number.IntegerCheck;
import org.jlf.plugin.server.core.check.custom.detail.number.LongCheck;
import org.jlf.plugin.server.core.check.custom.detail.number.ShortCheck;
import org.jlf.plugin.server.core.check.suctom.detail.collection.ListCheck;
import org.jlf.plugin.server.core.check.suctom.detail.collection.MapCheck;
