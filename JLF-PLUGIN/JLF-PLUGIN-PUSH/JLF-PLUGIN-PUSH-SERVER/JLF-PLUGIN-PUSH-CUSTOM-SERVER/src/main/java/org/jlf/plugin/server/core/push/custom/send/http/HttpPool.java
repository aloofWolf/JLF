...
public class HttpPool {
	 ...
	 * @param config
	 */
	public HttpPool(JLFPushHttpConfig config) {
	 ...
	 * @param config
	 */
	private void initClientConnectionManager(JLFPushHttpConfig config) {
	 ...
	 * @return
	 */
	private Registry<ConnectionSocketFactory> initConnectionSocketFactory(JLFPushHttpConfig config) {
